...
//租户中心列表
export const getTenantList = (params?: any): Promise<ResponseType> =>
  request().get('/api/opcloud/sys/org/list', { params });
//拖拽修改服父子级关系
export const getmodifyOrgParentAndLevel = (params?: any): Promise<ResponseType> =>
  request().post('/api/opcloud/sys/org/modifyOrgParentAndLevel', params);

//新增租户
export const addTenant = (params?: any): Promise<ResponseType> =>
  request().post('/api/opcloud/sys/org/add', params);

//修改租户
export const editTenant = (params?: any): Promise<ResponseType> =>
  request().post('/api/opcloud/sys/org/update', params);

//根据orgId获取当前组织和子组织
export const getOrgListByIdWithPage = (params?: any): Promise<ResponseType> =>
  request().get('/api/opcloud/sys/org/getOrgListByIdWithPage', { params });

//禁用租户
export const disableTenant = (params?: any): Promise<ResponseType> =>
  request().post('/api/opcloud/sys/org/disable', params);

//反禁用租户
export const antiDisableTenent = (params?: any): Promise<ResponseType> =>
  request().post('/api/opcloud/sys/org/antiDisable', params);
...
//审核租户
export const auditTenant = (params?: any): Promise<ResponseType> =>
  request().post('/api/opcloud/sys/org/audit', params);

//反审核租户
export const antiAuditTenant = (params?: any): Promise<ResponseType> =>
  request().post('/api/opcloud/sys/org/antiAudit', params);
...
//功能管理列表
export const getFuncList = (params: any): Promise<ResponseType> =>
  request().get('/api/opcloud/sys/func/list', { params });

//功能新增
export const addFunc = (params: any): Promise<ResponseType> =>
  request().post('/api/opcloud/sys/func/add', params);

//功能编辑
export const editFunc = (params: any): Promise<ResponseType> =>
  request().put('/api/opcloud/sys/func/update', params);

//功能删除
export const delFunc = (params: any): Promise<ResponseType> =>
  request().delete('/api/opcloud/sys/func/delete', { params });
...
export const getUsersByDepartmentId = (params: any): Promise<ResponseType> =>
  request().get('/api/opcloud/sys/department/getUsersByDepartmentId', { params });
...
export const removeUserFromDepartment = (params: any): Promise<ResponseType> =>
  request().post('/api/opcloud/sys/department/removeUserFromDepartment', params);
