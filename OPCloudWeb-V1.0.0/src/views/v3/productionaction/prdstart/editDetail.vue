            ...
            <rotate-row title="任务信息">
                <el-col :span="8">
                    <el-form-item label="开工单号" prop="startNbr">
                        ...
                        <el-input v-model="pageData.formData.startNbr" disabled readonly></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="工序识别码" prop="processId">
                        ...
                        <el-input disabled v-model="pageData.formData.processUniqueNbr" readonly></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
            ...
            <rotate-row title="开工信息">
                ...
                <el-col :span="8">
                    <el-form-item label="开工数量" prop="startQty">
                        <el-input disabled v-model="pageData.formData.startQty"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="汇报数量" prop="totalReportQty">
                        <el-input disabled v-model="pageData.formData.totalReportQty"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="合格数量" prop="qualifiedQty">
                        <el-input disabled v-model="pageData.formData.qualifiedQty"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="不合格数量" prop="unqualifiedQty">
                        <el-input disabled v-model="pageData.formData.unqualifiedQty"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="8">
                    <el-form-item label="开工时间" prop="startTime">
                        <!-- <el-input v-model="pageData.formData.no"></el-input> -->
                        <el-input disabled v-model="pageData.formData.startTime"></el-input>
                    </el-form-item>
                </el-col>
            </rotate-row>
        </el-form>
