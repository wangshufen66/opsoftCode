...
const formRules = reactive({
    'pageData.formData.qty': [{ required: true, message: "该字段必填", trigger: "change" }],
});
...
const dialogBadReason = useDialog({
    _onConfirm: (_rows) => {
        ...
        pageData.formData.badReasonName = _rows[0].fullName
        pageData.formData.badReasonNbr = _rows[0].code
    }
})
