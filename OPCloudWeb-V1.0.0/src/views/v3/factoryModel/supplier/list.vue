...
y<template>
                ...
                <div class="top-serach">
                    <el-col :span="10">
                        <el-form-item label="供应商代码">
                            <el-input
                                type="text"
                                v-model.trim="searchForm.supplierNbr"
    ...
    <div class="fixedDialog">
        <el-dialog v-model="editDialog.visible" :destroy-on-close="true" width="1000px">
            <template #title>
                 <dialog-title :title="editDialog.param.showType == 1?'新增供应商':editDialog.param.showType == 2?'编辑供应商':'查看供应商'" ></dialog-title>
            </template>
