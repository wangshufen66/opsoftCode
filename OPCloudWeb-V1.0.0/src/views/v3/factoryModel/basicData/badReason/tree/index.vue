<template>
    <div class="m-tree">
        <el-button-group class="m-tree-tool">
            <div class="each" @click.stop="editDialog.show({ row: null, showType: 2 })">
                <i class="el-icon-plus"></i>
            </div>
            <div class="each" @click.stop="editDialog.show({ row: activeNode, showType: 2 })">
...
import GroupApi from "@/api/controller/badReasonGroupApi";
