...
y<template>
    <div class="m-page-list">
            ...
            <el-form mode="topForm" class="topForm" :inline="true" @submit.prevent>
                ...
                <div class="top-serach">
                    <el-form-item label="人员代码">
                        <el-input
                            type="text"
                            v-model.trim="searchForm.employeeNbr"
                    ...
                    <el-form-item label="人员名称">
                        <el-input
                            type="text"
                            v-model.trim="searchForm.employeeName"
                            @keyup.enter="tableGatherFunc.reLoadTableData"
                            clearable
                        ></el-input>
                    </el-form-item>
        ...
        <div class="m-page-list-table" style="height:100%">
            ...
            >
                ...
                <template #col_gender="{ data }">{{ renderDictionTag(data.gender, 'gender') }}</template>
    ...
    <div class="fixedDialog">
        <el-dialog v-model="editDialog.visible" :destroy-on-close="true" width="1200px">
            <template #title>
                    <dialog-title :title="editDialog.param.showType == 1?'新增人员':editDialog.param.showType == 2?'编辑人员':'查看人员'" ></dialog-title>
