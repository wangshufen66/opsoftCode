...
y<template>
        ...
        <div class="m-page-list-search">
            <el-form mode="topForm" class="topForm" :inline="true" @submit.prevent>
                <div class="top-button">
                    ...
                    <el-button type="primary" @click="onAntiDisable" plain size="small">反禁用</el-button>
                ...
                <div class="top-serach">
                    <el-form-item label="类别代码">
                        <el-input
                            type="text"
                            v-model.trim="searchForm.categoryNbr"
                    ...
                    <el-table-column label="操作" fixed="right" width="120">
                        <template #default="scope">
                            <text-button
                                ...
                                @click="editDialogFunc.show(scope.row, 2)"
                            >编辑</text-button>
                            <text-button v-if="scope.row.type != 1" @click="del(scope)">删除</text-button>
                        </template>
                    </el-table-column>
                </template>
            </table-extend>
    ...
    <div class="fixedDialog">
        <el-dialog v-model="editDialog.visible" :destroy-on-close="true" width="700px">
            <template #title>
                 <dialog-title :title="editDialog.param.showType == 1?'新增物料类别':editDialog.param.showType == 2?'编辑物料类别':'查看物料类别'" ></dialog-title>
            </template>
...
import BuzApi from "@/api/controller/materialCategoryApi";
