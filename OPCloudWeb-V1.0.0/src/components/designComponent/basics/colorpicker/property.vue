  ...
  <el-form :model="formModel" :rules="formRules" ref="formRef" label-width="100px" size="small">
    ...
    <el-form-item label="默认值">
      <span style="display:flex;">
        <el-color-picker v-bind="componentCfg.__attr__" v-model="componentCfg.__config__.defaultValue"></el-color-picker>
      </span>
    </el-form-item>
    ...
    <el-form-item label="颜色格式">
      <el-select v-model="componentCfg.__attr__['color-format']" placeholder="请选择颜色格式" @change="colorFormatChange">
...
import { colorFormatOptions } from "@/use/useConst";
