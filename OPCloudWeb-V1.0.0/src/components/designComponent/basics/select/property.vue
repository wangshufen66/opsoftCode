      ...
      >
        <template v-if="componentCfg?.__relTable__.key">
          <el-option
            ...
            :key="item.value"
            :value="item[componentCfg.__props__.value]"
            :label="item[componentCfg.__props__.label]"
          ></el-option>
        </template>
        <template v-else>
          <el-option
            v-for="item in componentCfg?.options"
            :key="item.value"
            :value="item[componentCfg?.__props__.value]"
            :label="item[componentCfg?.__props__.label]"
          ></el-option>
      ...
      <template #item="{ element, index }">
        <div class="select-item">
          <div
            ...
            @click.stop="componentCfg.options.splice(index, 1)"
          >
