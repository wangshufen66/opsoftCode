...
<template>
  <el-form :model="formModel" :rules="formRules" ref="formRef" label-width="100px" size="small">
    ...
    <el-form-item label="默认值">
      <el-date-picker v-model="componentCfg.__config__.defaultValue" :type="componentCfg.__config__.type" v-bind="componentCfg.__attr__" style="width:100%;"></el-date-picker>
    </el-form-item>
    ...
    <!-- <el-form-item label="显示类型">
      <el-select v-model="componentCfg.__config__.type" placeholder="请选择显示类型" @change="onDateTypeChange" style="width:100%;">
    ...
    <el-form-item>
      ...
      <!-- <el-select v-model="componentCfg.__attr__.format" placeholder="请选择日期格式">
        <el-option value="datas" label="datas"></el-option>
        <el-option value="yyyy-MM-dd" label="年-月-日"></el-option>
        <el-option value="yyyy-MM-dd HH:mm" label="年-月-日 时:分"></el-option>
        <el-option value="yyyy-MM-dd HH:mm:ss" label="年-月-日 时:分:秒"></el-option>
      </el-select>-->
    </el-form-item>
...
import { dateTimeFormat, dateTypeOptions } from "@/use/useConst";

export default {
  name: "MultiDatePickerProperty",
  props: {
    componentCfg: Object,
  },
  setup(props, { emit }) {
