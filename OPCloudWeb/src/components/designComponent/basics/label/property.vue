...
<template>
  <el-form ref="formRef" label-width="100px" size="small">
    ...
    <el-form-item label="头部图标">
      <el-input v-model="componentCfg.__attr__['prefix-icon']" placeholder="设置最大长度" clearable @change="onIconChange">
        <template #append>
    ...
    <template v-if="componentCfg.__attr__.prefixLine">
      <el-form-item label="标线宽度">
        <el-input v-model="componentCfg.__attr__.prefixLineWidth" placeholder="设置前置标线宽度" clearable></el-input>
      </el-form-item>
