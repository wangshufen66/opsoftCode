...
<template>
  <el-form :model="formModel" :rules="formRules" ref="formRef" label-width="100px" size="small">
    ...
    <el-form-item label="最大长度">
      <el-input-number v-model="componentCfg.__attr__.maxlength" :min="1" :max="100" placeholder="设置最大长度" controls-position="right" style="width:100%;"></el-input-number>
    </el-form-item>
    ...
    <!-- <property-data-model :componentCfg="componentCfg"></property-data-model> -->
