<template>
  <el-time-picker v-model="model[component.__vModel__]" v-bind="component.__attr__">
  </el-time-picker>
</template>
...
export default {
  name: 'designTimeRangePicker',
  props: {
    component: Object as PropType<TimeRangePickerComponent>,
    model: Object,
  },
  setup(props) {
    function init() {
