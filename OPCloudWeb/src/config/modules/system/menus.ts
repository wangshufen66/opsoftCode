const menus = [
  ...
  },
  {
    ...
    children: [
      {
        key: "model_createmodel",
        title: "创建模型",
        path: "/systemset/mange/createmodel",
        pathName: "模型管理_创建模型",
      },
      {
        key: "model_calculation",
        title: "计算模型管理",
