    ...
    <el-form mode="topForm" :inline="true" @submit.prevent>
      <el-col :span="12">
        <el-form-item label="页面名称">
          <el-input type="text" v-model="topForm.pageName" clearable @keyup.enter="getPageList"></el-input>
        </el-form-item>
      </el-col>
      <el-button type="primary" @click="getPageList">点击搜索</el-button>
      <el-button type="primary" @click="addPage" icon="el-icon-plus">添加页面</el-button>
    </el-form>
  </div>
      ...
      <template #operatColumn>
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="scope">
            <el-button type="text" size="small" @click="goPageDesign(scope.row)">页面设计</el-button>
            <el-button type="text" size="small" @click="pageEdit(scope.row)">页面编辑</el-button>
...
import { setStorage, confirmBox, messageAlert, deepClone } from "@/utils/utils";
