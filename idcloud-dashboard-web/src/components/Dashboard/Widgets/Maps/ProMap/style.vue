  ...
  <div>
    <div v-show="tab === 1">
      ...
      <div class="panel-item-new">
        <div @click="isShowStyle = !isShowStyle" class="panel-item-title">
          样式设置
          <i
            :class="isShowStyle ? 'el-icon-caret-bottom' : 'el-icon-caret-right'"
        ...
        <div v-show="isShowStyle" class="panel-item-new-set">
          ...
          <div class="panel-row">
            ...
            <div class="panel-value panel-value-color-2">
              <el-color-picker v-model="activeElement.titleColor" show-alpha size="mini" />
            </div>
          </div>
          <!-- <div class="panel-row">
          ...
          <div class="panel-row">
            ...
            <div class="panel-value panel-value-color-2">
              <el-color-picker v-model="activeElement.mapBorderColor" show-alpha size="mini" />
            </div>
          </div>
          <div class="panel-row">
          ...
          <div class="panel-row">
            ...
            <div class="panel-value panel-value-color-2">
              <el-color-picker v-model="activeElement.mapEmphasisAreaColor" show-alpha size="mini" />
            </div>
          </div>
          <div class="panel-row" flex>
            ...
            <div class="panel-value">
              <label class="form-switch">
                <input v-model="activeElement.showVisualMap" type="checkbox" />
                <i class="form-icon" />
              </label>
            </div>
          </div>
          <div v-show="activeElement.showVisualMap" class="panel-row">
            <div class="panel-label">值域条文本</div>
            <div class="panel-value panel-value-color-1">{{ activeElement.visualTextColor }}</div>
            <div class="panel-value panel-value-color-2">
              <el-color-picker v-model="activeElement.visualTextColor" show-alpha size="mini" />
            </div>
          </div>
        </div>
      </div>
      <div class="panel-item-new">
        <div @click="isShowMap = !isShowMap" class="panel-item-title">
          地图设置
          <i
            :class="isShowMap ? 'el-icon-caret-bottom' : 'el-icon-caret-right'"
            class="panel-title-arrow"
          ></i>
        </div>
    ...
    <div v-show="tab === 3">
      ...
      <div v-show="activeElement.autoToolTip" class="panel-row">
