    ...
    <div v-show="tab === 3">
      ...
      <div class="panel-item-new">
        <div @click="isShowTITLE = !isShowTITLE" class="panel-item-title">
          标题设置
          <i
            :class="isShowTITLE ? 'el-icon-caret-bottom' : 'el-icon-caret-right'"
            class="panel-title-arrow"
          ></i>
        </div>
      ...
      <div class="panel-item-new">
        <div @click="isShowChart = !isShowChart" class="panel-item-title">
          图表设置
          <i
            :class="isShowChart ? 'el-icon-caret-bottom' : 'el-icon-caret-right'"
            class="panel-title-arrow"
          ></i>
        </div>
