...
const WIDGET_NAME = "AreaBarChart";
export default {
  name: WIDGET_NAME,
  group: "chart",
  icon: require("./icon/thumb.png"),
  title: "堆叠条形图",
  panel: stylec,
  setting: {
    type: WIDGET_NAME,
