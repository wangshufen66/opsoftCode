      ...
      <div class="panel-item-new">
        ...
        <div v-show="isShowLine" class="panel-item-new-set">
          ...
          <div class="panel-row" style="display: none">
            ...
            <div class="panel-value">
              <label class="form-switch">
                <input v-model="activeElement.seriesBarGap" type="checkbox" />
                <i class="form-icon" />
              </label>
            </div>
          </div>
            ...
            >
              <div>
                ...
                <div class="panel-row">
                  ...
                  <div>
                    <input
                      v-model="activeElement.seriesBarWidth[editableTabsValue]"
                    />
                  </div>
                </div>
                <div class="panel-row">
                  ...
                  <div>
                    <input
                      v-model.number="
                        activeElement.seriseRadiuses[editableTabsValue][0]
                      "
                      type="number"
                      min="0"
                      max="99"
                    ...
                    <input
                      v-model.number="
                        activeElement.seriseRadiuses[editableTabsValue][1]
                      "
                      type="number"
                      min="0"
                      max="99"
                ...
                <div class="panel-row">
                  ...
                  <div>
                    <input
                      v-model.number="
                        activeElement.seriseRadiuses[editableTabsValue][2]
                      "
                      type="number"
                      min="0"
                      max="99"
                    ...
                    <input
                      v-model.number="
                        activeElement.seriseRadiuses[editableTabsValue][3]
                      "
                      type="number"
                      min="0"
                      max="99"
