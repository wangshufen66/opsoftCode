  ...
  <header class="header">
    <div class="navbar1 container grid-xl">
      ...
      <section class="navbar-cont navbar-right">
        ...
        <a class="btn btn-link tooltip tooltip-bottom" data-tooltip="撤销 Ctrl + Z" @click="undo">
          <vpd-icon name="undo" />撤销
        </a>
        <a class="btn btn-link" @click="save">
          <vpd-icon name="save" />保存
        </a>
        <a class="btn btn-link" @click="preview">
          <vpd-icon name="preview" />预览
        </a>
        <a class="btn btn-link" @click="quit">
          <vpd-icon name="quit" />退出
        </a>
      </section>
