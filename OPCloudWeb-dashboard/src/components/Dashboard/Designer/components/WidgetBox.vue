<template>
  <div class="menu-bar">
    <ul class="widget-box" @mousedown="updateSrollTop">
      <li class="btn-item" style="cursor: default;" v-for="sort in widgetClassOptions" :key="sort.value" @mouseover="selectStyle (sort) " @mouseout="outStyle(sort)">
        ...
        <div class="btn-item__list" v-show="sort.active">
          <div class="list-container">
            <ul class="tool-list clearfix">
              <li v-for="item in widgets(sort.value)" :key="item.name" @click="(e) => {addWidget(e, item)}">
...
const widgetClassOptions = [
  ...
  { value: 'border', text: '边框', icon: 'ipvisits' },
  { value: 'decoration', text: '装饰', icon: 'nested' },
];
