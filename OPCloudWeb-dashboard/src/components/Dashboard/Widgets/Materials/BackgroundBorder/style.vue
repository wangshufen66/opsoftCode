  ...
  <div>
    <div v-show="tab === 1">
      ...
      <div class="panel-item-new">
        <div @click="isShowBorder = !isShowBorder" class="panel-item-title">
          风格
          <i
            :class="isShowBorder ? 'el-icon-caret-bottom' : 'el-icon-caret-right'"
            class="panel-title-arrow"
          ></i>
        </div>
        <div v-show="isShowBorder" class="panel-item-new-set">
          <div class="panel-row" flex>
            <div class="panel-label">边框风格</div>
            <div class="panel-value">
              <select v-model="activeElement.picValue">
                <option value="bg1">默认</option>
                <option value="bg2">类型1</option>
                <option value="bg3">类型2</option>
                <option value="bg4">类型3</option>
                <option value="bg5">类型4</option>
                <option value="bg6">类型5</option>
                <option value="bg7">类型6</option>
                <option value="bg8">类型7</option>
              </select>
            </div>
          </div>
          <div class="panel-row">
            <div class="panel-label">Slice</div>
            <div class="panel-value">
              <input v-model="activeElement.borderImageSlice" type="number" min="0" />
            </div>
          </div>
        </div>
      </div>
...
.panel-item-detail-left,
.panel-item-detail-right {
  display: flex;
}
...
.panel-item-new .panel-item-detail .panel-item-detail-left input,
.panel-item-new .panel-item-detail .panel-item-detail-right input {
  width: 100px;
  height: 30px;
}
.xf-background {
