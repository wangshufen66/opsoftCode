  ...
  <div>
          ...
          <div class="panel-row">
            ...
            <div class="panel-value panel-basicTable-tbPercent-cont">
              <span class="panel-basicTable-inp-span" v-for="(item, index) in activeElement.tbPercent" :key="index">
                <input class="panel-basicTable-inp" v-model.number="activeElement.tbPercent[index]" type="number" max="9">{{index === activeElement.tbPercent.length - 1 ? '' : ' ： '}}
              </span>
            </div>
          </div>
          <div class="panel-row">
    ...
    <div v-show="tab === 3">
      <div class="panel-row">
        ...
        <div>
          <input v-model="activeElement.dataLength" type="number" @change="change" min="1">
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    change() {
      ...
      console.log(this.activeElement.dataLength);
    },
    addthNumBgColor() {
      let params = {
