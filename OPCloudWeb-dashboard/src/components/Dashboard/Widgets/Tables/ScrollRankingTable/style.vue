        ...
        <div v-show="isShowHead" class="pane l-item-new-set">
          <!-- <div class="panel-row" flex>
            ...
            <div class="panel-value">
              <label class="form-switch">
                <input v-model="activeElement.showTh" type="checkbox">
                <i class="form-icon" />
              </label>
            </div>
          </div> -->
          <!-- <div class="panel-row" v-show="activeElement.showTh">
            ...
            <div class="panel-colorpick">
              <el-color-picker v-model="activeElement.thColor" show-alpha size="small" />
            </div>
          </div> -->
          <!-- <div class="panel-row" v-show="activeElement.showTh">
            ...
            <div class="panel-colorpick">
              <el-color-picker v-model="activeElement.thBgColor" show-alpha size="small" />
            </div>
          </div> -->
          <!-- <div class="panel-row">
          ...
          <!-- <div v-show="activeElement.showTh" class="panel-row">
            ...
            <div class="panel-value">
              <input v-model="activeElement.thFontSize" type="number">
            </div>
          </div> -->
          <div class="panel-row">
          ...
          <div class="panel-row">
            <div class="panel-label">轮播方式</div>
            <div class="panel-value">
              <el-radio-group class="panel-radio-cont" v-model="activeElement.carouselMode" @change="change" size="small">
                <el-radio label="single">每行</el-radio>
                <el-radio label="page">每页</el-radio>
              </el-radio-group>
          ...
          <div class="panel-row" flex>
            <div class="panel-label">自动排序</div>
            <div class="panel-value">
              <label class="form-switch">
                <input v-model="activeElement.autoSorting" type="checkbox" />
                <i class="form-icon" />
              </label>
            </div>
          </div>
      ...
      <!-- <div class="panel-item-new">
        ...
        <div v-show="isShowNum" class="panel-item-new-set">
          <div class="panel-row" flex>
            ...
            <div class="panel-value">
              <label class="form-switch">
                <input v-model="activeElement.showNum" type="checkbox">
                <i class="form-icon" />
              </label>
            </div>
          </div>
          ...
          <div v-show="activeElement.showNum" class="panel-row">
            ...
            <div class="panel-value">
              <input v-model="activeElement.thNumWidth" type="number">
            </div>
          </div>
          <div v-show="activeElement.showNum" class="panel-row">
            <div class="panel-label">文本大小</div>
            <div class="panel-value">
              <input v-model="activeElement.thNumFontSize" type="number">
            </div>
          </div>
          <div class="panel-row" v-show="activeElement.showNum">
            ...
            <div class="panel-colorpick">
              <el-color-picker v-model="activeElement.thNumColor" show-alpha size="small" />
            </div>
          </div>
          <div v-show="activeElement.showNum" class="panel-row">
          ...
          <div style="display: none" class="panel-row">
            <div class="panel-label">配置颜色</div>
            <div class="panel-setcolor">
              <div v-for="(item,index) in activeElement.thNumBg" :key="index" class="panel-setcolor-item">
                <div class="panel-value-new">{{ item }}</div>
                <div>
                  <input v-model="activeElement.thNumBg[index]" type="color">
                </div>
                <button v-if="index == 0" class="pannel-setcolor-item-btn" @click="addthNumBgColor">添加</button>
                <button v-else class="pannel-setcolor-item-btn" @click="delthNumBgColor(index)">删除</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- <div class="panel-item-new">
        ...
        <div v-show="isShowTable" class="panel-item-new-set">
          ...
          <div class="panel-row">
            <div class="panel-label">文本大小</div>
            <div class="panel-value">
              <input v-model="activeElement.tbFontSize" type="number">
            </div>
          </div>
          <div class="panel-row">
            <div class="panel-label">文本颜色</div>
            ...
            <div class="panel-colorpick">
              <el-color-picker v-model="activeElement.tbColor" show-alpha size="small" />
            </div>
          </div>
...
export default {
  ...
  methods: {
    change() {
      console.log(this.activeElement.carouselMode);
    },
    addthNumBgColor() {
      let params = {
