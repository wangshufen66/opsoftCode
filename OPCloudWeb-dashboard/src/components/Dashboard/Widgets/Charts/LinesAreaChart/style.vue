            ...
            >
              <div>
                ...
                <div class="panel-row">
                  ...
                  <div>
                    <input
                      v-model="activeElement.seriesLineWidth[editableTabsValue]"
                      type="number"
                      min="0"
                    />
                  </div>
                ...
                <div class="panel-row" flex>
                  ...
                  <div class="panel-value">
                    <label class="form-switch">
                      <input v-model="activeElement.isSmooth[editableTabsValue]" type="checkbox" />
                      <i class="form-icon" />
                    </label>
                  </div>
                </div>
                <div>
                  <div class="panel-row">
                    ...
                    <div class="panel-value">
                      <select v-model="activeElement.seriesSymbol[editableTabsValue]">
                ...
                <div v-show="activeElement.seriesSymbol !== 'none'" class="panel-row">
                  ...
                  <div>
                    <input
                      v-model="activeElement.seriesSymbolSize[editableTabsValue]"
                      type="number"
                      min="0"
                    />
                  </div>
