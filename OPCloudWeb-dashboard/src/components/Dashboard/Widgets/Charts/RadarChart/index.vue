...
export default {
  ...
  setting: {
    ...
    dataAPI:
      "https://easy-mock.com/mock/5c7ce20ccdc04f0e04185d9b/example/mock_copy_1560491079589/charts-radar", // API拉取地址
  ...
  computed: {
    categories() {
      if (
        ...
        let arr = this.dynamicData[this.val.keyPrimary][this.val.keyTarget][
          this.val.keyXAxis
        ];
        return arr.map((item) => {
          return { text: item };
