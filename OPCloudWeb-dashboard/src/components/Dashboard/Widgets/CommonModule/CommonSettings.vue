<template>
  <div>
    <div class="panel-item-new">
      <div @click="isShowLegend = !isShowLegend" class="panel-item-title">
        图例设置<i
          :class="isShowLegend ? 'el-icon-caret-bottom' : 'el-icon-caret-right'"
      ...
      <div v-show="isShowLegend" class="panel-item-new-set">
        <div class="panel-row" flex>
          ...
          <div class="panel-value">
            <label class="form-switch">
              <input v-model="activeElement.legendShow" type="checkbox" />
              <i class="form-icon" />
            </label>
          </div>
        </div>
        <div v-show="activeElement.legendShow" class="panel-row">
        ...
        <div v-show="activeElement.legendShow" class="panel-row" flex>
          <div class="panel-label">对齐</div>
          <div class="panel-value">
            <el-radio-group
              class="panel-radio-cont"
