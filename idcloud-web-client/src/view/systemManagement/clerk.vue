...
<script>
  ...
  import clerkTableColumns from "../tableColumns/clerkTableColumns";
  ...
  import teamTableColumns from "../tableColumns/teamTableColumns";
  import {getList as getTeamList, getGroupList as getTeamGroupList} from "@/api/factoryModel/team";
  ...
  export default {
      ...
      return {
        ...
        tableDetailForm: {
          ...
          idForm: {
            ...
            rules: {
              name: [{required: true, message: "员工名称不能为空", trigger: ['blur', 'change']}],
            },
            component: [
              //需要class化
              {
    ...
    created() {
      ...
      this.tableDetailForm.idForm.component[4].event.confirm = function (row) {
        ...
        that.tableDetailForm.idForm.data.teamNumber = row.number;
      ...
      this.tableDetailForm.idForm.component[8].event.beforeGetTableList = function (filterData) {
        filterData.orgId = that.tableDetailForm.idForm.data.orgId;
      };
    ...
    methods: {
      beforeGetTableList(filterData) {
        filterData.showAll = this.actionBarConfig[4].vModel;
        filterData.orgId = filterData.groupId;
      ...
      initTableDetail(data, treeSelectData) {
        if (data) {
          ...
          this.tableDetailForm.idForm.data = {
            id: '',
            // orgId: this.$store.state.user.userInfo.orgId,//组织
            orgId: treeSelectData ? treeSelectData.id : 0,//组织内码
            orgNumber: treeSelectData? treeSelectData.number : '',//组织代码
            orgName: treeSelectData ? treeSelectData.name : '',//组织名称
            number: '',//员工代码
            name: '',//员工名称
            type: '0',//员工属性
            departmentId: 0,//部门内码
        ...
        //处理部门弹窗问题
        this.handleInputPopup('departmentName',
        ...
        //处理班组弹窗问题
        this.handleInputPopup('teamName',
          this.tableDetailForm.idForm.data.teamId,
          this.tableDetailForm.idForm.data.teamNumber,
          this.tableDetailForm.idForm.data.teamName
        );
        //统一处理弹窗遗留问题
