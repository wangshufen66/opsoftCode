...
<script>
  ...
  import supplierTableColumns from "../tableColumns/supplierTableColumns"
      ...
      return {
        ...
        actionBarConfig: [
          ...
          },
          {
            tag: "id-excel",
            excelName: "供应商",
            getTemplate: getSupplierTemplate,
            importTemplate: importSupplierTemplate,
          },
          {
            tag: "el-checkbox",
            classKey: "showAll",
      ...
      initTableDetail(data, treeSelectData) {
        if (data) {
          ...
          this.tableDetailForm.idForm.data = {
            ...
            groupName: treeSelectData?treeSelectData.name:"供应商",//分组名称
          };
        }
        //统一处理字段的可编辑
