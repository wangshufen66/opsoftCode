...
<script>
  ...
  export default {
      ...
      return {
        ...
        actionBarConfig: [
          ...
          },
          {
            tag: "id-excel",
            excelName: "班组",
            getTemplate: getTeamTemplate,
            importTemplate: importTeamTemplate,
          },
          {
            tag: "el-checkbox",
            classKey: "showAll",
        ...
        tableDetailForm: {
          ...
          idForm: {
            data: {
              ...
              number: '',//班组代码
              name: '',//班组名称
              chargePersonId: 0,//班长内码
              chargePersonNumber: '',//班长代码
              chargePersonName: '',//班长名称
              workStartTime:'',//上班时间
              workEndTime:'',//下班时间
              note: '',//备注
              //需要model化
            ...
            rules: {
              name: [{required: true, message: "班组名称不能为空", trigger: ['blur', 'change']}],
            },
            component: [
              //需要class化
              {
    ...
    created() {
      let that = this;
      this.tableDetailForm.idForm.component[2].event.beforeGetTableList = function (filterData) {
        filterData.auditStatus = 1;
        filterData.isDisable = false;
      };
      this.tableDetailForm.idForm.component[2].event.afterGetTablePage = function (tableData) {
      ...
      initTableDetail(data,treeSelectData) {
        if (data) {
          ...
          this.tableDetailForm.idForm.data = {
            ...
            groupName: treeSelectData?treeSelectData.name:"班组",//分组名称
          };
        }
        //统一处理字段的可编辑
