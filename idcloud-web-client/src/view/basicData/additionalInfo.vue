...
<script>
  ...
  import additionalInfoTableColumns from "../tableColumns/additionalInfoTableColumns";
      ...
      return {
        ...
        tableDetailForm: {
          ...
          idForm: {
            ...
            rules: {
              name: [
                {required: true, message: "辅助资料名称不能为空", trigger: ['blur', 'change']},
              ],
            },
            component: [
              //需要class化
      ...
      initTableDetail(data, treeSelectData) {
        if (data) {
          ...
          this.tableDetailForm.idForm.data = {
            ...
            groupName: treeSelectData?treeSelectData.name:"辅助基础资料",//分组名称
          };
