...
<script>
  ...
  import {
    ...
    setFieldList,
    getGroupList
  } from "@/api/basicData/warehousePosition";
  import {configAll} from "@/components/id-tree/idTreeConfig";
  import {
    getWarehousePositionTemplate,
    importWarehousePositionTemplate,
      ...
      return {
        ...
        actionBarConfig: [
          ...
          },
          {
            tag: "id-excel",
            excelName: "仓位",
            getTemplate: getWarehousePositionTemplate,
            importTemplate: importWarehousePositionTemplate,
          },
          {
            tag: "el-checkbox",
            classKey: "showAll",
        ...
        tableDetailForm: {
          ...
          idForm: {
            ...
            rules: {
              name: [{required: true, message: "仓位名称不能为空", trigger: ['blur', 'change']}],
              warehouseName: [{required: true, message: "仓库不能为空", trigger: ['blur', 'change']}],
            },
            component: [
              //需要class化
              {
      ...
      initTableDetail(data,treeSelectData) {
        if (data) {
          ...
          this.tableDetailForm.idForm.data = {
            ...
            groupName: treeSelectData?treeSelectData.name:"仓位",//分组名称
          };
        }
        //统一处理字段的可编辑
        ...
        //修改仓库弹窗问题
        this.handleInputPopup('warehouseName',
