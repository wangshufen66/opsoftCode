...
<script>
  ...
  import warehouseTableColumns from "../tableColumns/warehouseTableColumns";
  ...
  export default {
      ...
      return {
        ...
        actionBarConfig: [
          ...
          },
          {
            tag: "id-excel",
            excelName: "仓库",
            getTemplate: getWarehouseTemplate,
            importTemplate: importWarehouseTemplate,
          },
          {
            tag: "el-checkbox",
            classKey: "showAll",
        ...
        tableDetailForm: {
          ...
          idForm: {
            data: {
              ...
              type: '0',//仓库类别
              address:'',//地理位置
              chargePersonId: 0,//负责人内码
              chargePersonNumber: '',//负责人代码
              chargePersonName: '',//负责人名称
    ...
    created() {
      let that = this;
      this.tableDetailForm.idForm.component[4].event.beforeGetTableList = function (filterData) {
        filterData.auditStatus = 1;
        filterData.isDisable = false;
      };
      this.tableDetailForm.idForm.component[4].event.afterGetTablePage = function (tableData) {
      ...
      this.tableDetailForm.idForm.component[4].event.confirm = function (row) {
        ...
        that.tableDetailForm.idForm.data.chargePersonPhone = row.phone;
      ...
      initTableDetail(data, treeSelectData) {
        if (data) {
          ...
          this.tableDetailForm.idForm.data = {
            ...
            groupName: treeSelectData ? treeSelectData.name : "仓库",//分组名称
          };
        }
        //统一处理字段的可编辑
        ...
        //修改负责人弹窗问题
        this.handleInputPopup('chargePersonName',
          this.tableDetailForm.idForm.data.chargePersonId,
          this.tableDetailForm.idForm.data.chargePersonNumber,
          this.tableDetailForm.idForm.data.chargePersonName
        );
        //统一处理弹窗遗留问题
