...
<script>
  ...
  import {
    getProdProcessTemplate,
    importProdProcessTemplate,
  } from "@/api/factoryModel/excelupdownload";
  import treeTableFormADMixins from "@/mixins/treeTableFormADMixins";
  import pordProcessTableColumns from "../tableColumns/pordProcessTableColumns";
      ...
      return {
        ...
        actionBarConfig: [
          ...
          },
          {
            tag: "id-excel",
            excelName: "工序",
            getTemplate: getProdProcessTemplate,
            importTemplate: importProdProcessTemplate,
          },
          {
            tag: "el-checkbox",
            classKey: "showAll",
        ...
        tableDetailForm: {
          ...
          idForm: {
            ...
            rules: {
              name: [
                {required: true, message: "工序名称不能为空", trigger: ['blur', 'change']},
              ],
            },
            component: [
              //需要class化
      ...
      initTableDetail(data,treeSelectData) {
        if (data) {
          ...
          this.tableDetailForm.idForm.data = {
            ...
            groupName: treeSelectData?treeSelectData.name:"工序",//分组名称
          };
