      ...
      return {
        ...
        actionBarConfig: [
          ...
          },
          {
            tag: "id-excel",
            excelName: "不良原因",
            getTemplate: getCauseTemplate,
            importTemplate: importCauseTemplate,
          },
          {
            tag: "el-checkbox",
            classKey: "showAll",
        ...
        tableDetailForm: {
          ...
          idForm: {
            ...
            rules: {
              name: [
                {required: true, message: "不良原因名称不能为空", trigger: ['blur', 'change']},
              ],
            },
            component: [
              //需要class化
    ...
    methods: {
      ...
      afterGetTablePage(tableData) {
        tableData.forEach((tItem) => {
          ...
          tItem.scrapStatus = tItem.scrapStatus ? '是' : '否';
        });
      },
      initTableDetail(data, treeSelectData) {
        if (data) {
          ...
          this.tableDetailForm.idForm.data.scrapStatus = this.tableDetailForm.idForm.data.scrapStatus === 1;
        } else {
          this.tableDetailForm.idForm.data = {
            ...
            groupName: treeSelectData?treeSelectData.name:"不良类别",//分组名称
          };
