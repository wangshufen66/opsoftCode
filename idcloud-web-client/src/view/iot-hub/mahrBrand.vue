      ...
      return {
        ...
        tableDetailForm: {
          ...
          idForm: {
            ...
            rules: {
              number: [{required: true, message: "马尔品牌型号代码不能为空", trigger: ['blur', 'change']}],
              mahrBrand: [{required: true, message: "马尔品牌不能为空", trigger: ['blur', 'change']}],
              mahrModel: [{required: true, message: "马尔型号不能为空", trigger: ['blur', 'change']}],
              name: [{required: true, message: "马尔品牌型号描述不能为空", trigger: ['blur', 'change']}],
            },
            component: [
              //需要class化
              {
      ...
      initListDetail(index, row, callBack) {
        if (row) {
          ...
          this.formList[0].form.data = {
            mahrBrandId: this.tableDetailForm.idForm.data.id,//表单Id
            id: "",
            collectionNumber: "",//云盒代码
            pointCodeId: 0,//数据点ID
            pointCodeNumber: "",//数据点代码
