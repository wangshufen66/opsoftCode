<template>
  <div id="x8303box-point-config-container" style="display: flex;flex-direction: row;margin-left:-27px">
    ...
    <div class="right-area-container" style="margin-left: 10px;flex-grow: 1;">
      <div class="parent-wrapper" v-if="formIntent === 'parent'">
        ...
        <div class="parent-body-wrapper">
          <el-card v-for="(item,index) in containerInfosData.box8303PointList" :key="index" class="body-card">
...
export default {
  name: 'box8303_infopoints_config',
  components: { IdTree },
  watch: {
    formIntent(n) {
      if (n === 'add') {
      ...
      try {
        this.$refs.theForm.validate(async (valid) => {
          if (valid) {
            const param = {
              orgId: this.orgId,
              box8303Id: this.containerInfosData.box8303Id,
              ...this.formValidate,
...
#x8303box-point-config-container {
