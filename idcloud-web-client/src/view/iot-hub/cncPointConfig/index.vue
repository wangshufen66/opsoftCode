<template>
  <div id="cnc-point-config-container"
    ...
    <div class="right-area-container"
      ...
      <div class="parent-wrapper" v-if="formIntent === 'parent'">
        ...
        <div class="parent-body-wrapper">
          <el-card
            v-for="(item,index) in containerInfosData.cncPointList"
            :key="index"
            class="body-card"
          >
...
<script>
  import {
    ...
    updateOne,
    getInfoPoint,
  } from "@/api/iot-hub/cncPointConfig";
        ...
        try {
          this.$refs.theForm.validate(async (valid) => {
            if (valid) {
              const param = {
                orgId: this.orgId,
                cncId: this.containerInfosData.cncId,
                ...this.formValidate,
