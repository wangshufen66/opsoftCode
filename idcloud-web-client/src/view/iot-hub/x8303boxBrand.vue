<template>
  <id-bar-query-table-dia-form tableErrTip="C8303品牌型号库" :actionBarConfig="actionBarConfig" :tableColumns="tableColumns" :tableDetailForm="tableDetailForm" form-label-width="100px" id-query-form-label-width="90px" :getTable="getTable" :getDetail="getDetail" :addDetail="addDetail" :updateDetail="updateDetail" :deleteTable="deleteTable" @editTableDetail="editTableDetail" @initTableDetail="initTableDetail">
...
import {
  ...
  updateMo as update,
} from '@/api/iot-hub/x8303boxBrand';
