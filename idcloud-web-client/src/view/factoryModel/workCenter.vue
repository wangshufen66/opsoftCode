...
<script>
  ...
  import {
    ...
    setFieldList,
    getGroupList
  } from "@/api/factoryModel/workCenter";
  import {configAll} from "@/components/id-tree/idTreeConfig";
  import {
    getWorkCenterTemplate,
    importWorkCenterTemplate,
      ...
      return {
        ...
        actionBarConfig: [
          ...
          },
          {
            tag: "id-excel",
            excelName: "工作中心",
            getTemplate: getWorkCenterTemplate,
            importTemplate: importWorkCenterTemplate,
          },
          {
            tag: "el-checkbox",
            classKey: "showAll",
        ...
        tableDetailForm: {
          ...
          idForm: {
            ...
            rules: {
              name: [{required: true, message: "工作中心名称不能为空", trigger: ['blur', 'change']}],
              departmentName: [{required: true, message: "所属部门不能为空", trigger: ['blur', 'change']}]
            },
            component: [
              //需要class化
              {
      ...
      initTableDetail(data, treeSelectData) {
        if (data) {
          ...
          this.tableDetailForm.idForm.data = {
            ...
            groupName: treeSelectData ? treeSelectData.name : "工作中心",//分组名称
          };
        }
        //统一处理字段的可编辑
