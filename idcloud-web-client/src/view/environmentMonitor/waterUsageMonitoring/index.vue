<template>
  <div class="container">
    <add-card-batch ref="addCard" :cardData="cardData" :hasHeadSubTitle="cardConfig.hasHeadSubTitle"
                    ...
                    :serverPage="tabs.waterUsageMonitoring.serverPage"
                    :hasPageBar="true"
                    :cardIcon="iconWater"
                    :tableConfig="tabs.waterUsageMonitoring.tableConfig"
      ...
      <template slot="switchOptions">
        <table-el
          ...
          :serverPage="tabs.waterUsageMonitoring.serverPage"
          :table-uni-key="tabs.waterUsageMonitoring.tableUniKey"
          :vuex-first-key="tabs.waterUsageMonitoring.vuexFirstKey"
          :vuex-second-key="tabs.waterUsageMonitoring.vuexSecondKey"
          :columns-std="tabs.waterUsageMonitoring.columnsStd"
          :table-config="tabs.waterUsageMonitoring.tableConfig"
          :hasAddButton="tabs.waterUsageMonitoring.tableConfig.hasAddButton"
    ...
    <el-dialog
      ...
      <waterUsage-monitoring-detail ref="detailComponent"
                                    :title="detailDialogTitle"
                                    style="margin-top: -40px"></waterUsage-monitoring-detail>
...
<script>
  ...
  import {findWaterList} from "@/api/environmentMonitor/waterUsageMonitor";
  import waterUsageMonitoringDetail
    from "@/view/environmentMonitor/waterUsageMonitoring/components/waterUsageMonitoringDetail.vue"
  ...
  export default {
      ...
      return {
        ...
        tabs: {
          waterUsageMonitoring: {
            ...
            vuexFirstKey: 'waterUsageMonitoring', // 表格组件获取 vuex 数据的 一级Key
            vuexSecondKey: 'waterUsageMonitoring', // 表格组件获取 vuex 数据的 二级Key
    ...
    methods: {
      initData() {
        ...
        this.requestData(this.tabs.waterUsageMonitoring.tableConfig.curPage, this.tabs.waterUsageMonitoring.tableConfig.pageSize)
      },

      changeCurrentPage(curPage) {
        this.tabs.waterUsageMonitoring.tableConfig.curPage = curPage
        this.requestData(this.tabs.waterUsageMonitoring.tableConfig.curPage, this.tabs.waterUsageMonitoring.tableConfig.pageSize)
      },
      changPageSize(pageSize) {
        this.tabs.waterUsageMonitoring.tableConfig.pageSize = pageSize
        this.requestData(this.tabs.waterUsageMonitoring.tableConfig.curPage, this.tabs.waterUsageMonitoring.tableConfig.pageSize)
      },

      requestData(curPage, curPageSize, callback) {
        this.switchDisabled = true
        this.tabs.waterUsageMonitoring.tableConfig.loading = true
        ...
        this.appendRequestFilterParams('waterUsageMonitoring', param)
        ...
        Promise.all(promiseArray).then(response => {
          ...
          this.tabs.waterUsageMonitoring.tableConfig.loading = false
        })
      },
      ...
      receiveTableData(response) {
        ...
        if (response.code !== 200) {
          ...
          this.tabs.waterUsageMonitoring.tableConfig.columns = this.detailViewTableColumns
          this.tabs.waterUsageMonitoring.tableConfig.countTotal = response.data.total
          this.$refs[`tableEl_waterUsageMonitoring`].drawTableData(this.detailViewTableColumns, tableData)
      ...
      handSwitch(data) {
        ...
        // this.initData()
        // this.handleRequestTablePageData('waterUsageMonitoring',1,10,null)
        this.$nextTick(() => {
          this.handleRequestTablePageData('waterUsageMonitoring',
            this.tabs.waterUsageMonitoring.tableConfig.curPage,
            this.tabs.waterUsageMonitoring.tableConfig.pageSize,
            null)
        })
      },
      //表格界面获取数据
      ...
      //查询，根据监测点名称
      handleSearch() {
        this.tabs.waterUsageMonitoring.tableConfig.curPage=1;
        this.tabs.waterUsageMonitoring.tableConfig.pageSize=10;
        this.switchDisabled = true
        this.tabs.waterUsageMonitoring.tableConfig.loading = true
        const param = {
          current_page: this.tabs.waterUsageMonitoring.tableConfig.curPage,
          page_size: this.tabs.waterUsageMonitoring.tableConfig.pageSize,
          orgId: this.$store.state.user.userInfo.orgId,
          containerName:this.tabs.waterUsageMonitoring.tableConfig.search
        }
