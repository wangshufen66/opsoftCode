...
const service = axios.create({
  // 以下获取当前环境的访问后台接口URL的方式已修改，
  // 为了能够使得打包后，能方便地修改一个配置文件来改变后台接口URL，便于部署后的维护工作
  // 原来的方式 process.env.BASE_API，如果打包后想修改后台接口URL，只能重新打包，太过麻烦
  baseURL: window.g[process.env.ENV_CONFIG].BOARD_API, // process.env.BOARD_API, api 的 base_url
