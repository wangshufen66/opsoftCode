...
export const constantRouterMap = [
  ...
  // 可单独打开的《图件配置》页面，已加入权限白名单，用于在其他web工程中通过 iFrame 集成页面
  {
    path: '/chartConfigSingle',
    component: () => import('@/views/chartConfig/index'),
    hidden: true
  },
  // 可单独打开的《模板配置》页面，已加入权限白名单，用于在其他web工程中通过 iFrame 集成页面
  {
    path: '/boardTemplateSingle',
    component: () => import('@/views/boardTemplate/index'),
    hidden: true
  },
  {
    path: '/previewReport',
    component: () => import('@/views/previewReport/index'),
    hidden: true
  },
  {
    path: '/editReport',
    component: () => import('@/views/editReport/index'),
    hidden: true
  },
  {
    path: '',
