    ...
    var i = function () {
        ...
        o = function () {
            ...
            return t.prototype.createTarget = function () {
                return this.target = $('<div class="hiprint-option-item-row"><div class="hiprint-option-item-label">外观设置</div></div> <div class="hiprint-option-item">\n        <div class="hiprint-option-item-label">\n        字体\n        </div>\n        <div class="hiprint-option-item-field">\n        <select class="auto-submit">\n        <option value="" >默认</option>\n            <option value="SimSun" >宋体</option>\n            <option value="Microsoft YaHei" >微软雅黑</option>\n        </select>\n        </div>\n    </div>'), this.target;
    ...
    var _r,
        ...
        ct = function () {
            ...
            return t.prototype.design = function (t, e) {
                ...
                if(Array.isArray(t)){
                    t.forEach((item)=>{
                        const jqEl = this.getHtml(item, e);
                        const el = jqEl&&jqEl[0];
                        elementList.push(el);
                    })
                }else{
                   t || (t = {});
                   const jqEl = this.getHtml(t, e)
                   const el = jqEl&&jqEl[0]
                   elementList.push(el);
                }
                const { printHtmlElement } = usePrint();
                printHtmlElement(elementList);
