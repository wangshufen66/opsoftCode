...
export const getReportNumber = (params?: any): Promise<ResponseType> =>
  request().post(`${userbase}/appdata/getReportNumber`, params);
...
export const getAppMenuList = (params?: any): Promise<ResponseType> =>
  request().get("/api/opcloud/application/apps/getUserMenuList", { params });
...
export const getAppPageInfo = (params?: any): Promise<ResponseType> =>
  request().get("/api/opcloud/application/apps/getPageInfo", { params });
