<template>
  <div class="fixedDialog">
    <component v-if="type" :is="formType" title="页面预览" v-model="visible" v-bind="dialogAttr">
      <el-form
        class="preview-form"
        ref="formRef"
        :model="formModel"
      ...
      >
        <template v-for="component in currentComponentList" :key="component.componentId">
          <el-col :span="component.__form__.span" v-if="!component.funType">
            ...
            >
              <component :is="component.componentTag" :model="formModel" :component="component"></component>
            </el-form-item>
          </el-col>
          <template v-else>
            <component :is="component.componentTag" :model="formModel" :component="component"></component>
      ...
      <template #footer v-if="type === 'dialog'">
        <span class="dialog-footer">
          <template v-if="formConf.showButton && formConf.buttonList.length > 0">
...
import { useForm, useFormDisplay } from "@/hooks/use-form";
