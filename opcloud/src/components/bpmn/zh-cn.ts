export default {
  ...
  'Append TimerIntermediateCatchEvent':'追加定时器中间件',
  'Append MessageIntermediateCatchEvent':'追加消息中间件',
  'Append ConditionIntermediateCatchEvent': '追加条件中间件',
  'Append SignalIntermediateCatchEvent': '追加信号中间件',
...
export const NodeName = {
  ...
  'bpmn:IntermediateCatchEvent': '中间件',
}
