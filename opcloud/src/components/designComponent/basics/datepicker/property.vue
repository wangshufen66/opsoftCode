...
<template>
  <el-form :model="formModel" :rules="formRules" ref="formRef" label-width="100px" size="small">
    ...
    <el-form-item label="默认值">
      <el-select v-model="componentCfg.__config__.defaultValue" placeholder="请选择默认值" clearable>
        <el-option label="当前系统时间" :value="1"></el-option>
      </el-select>
    </el-form-item>
    ...
    <el-form-item label="显示类型">
      <el-select
        v-model="componentCfg.__config__.type"
        placeholder="请选择显示类型"
