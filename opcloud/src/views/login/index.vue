  ...
  <div class="login-container">
    ...
    <div class="main-contain">
      ...
      <div class="login-form">
        <div class="login-logo containbg">欧软云登录</div>
          ...
          >
            ...
            <el-form-item>
              <div class="bottom-wrap">
                <span>
                  <a
                    class="opfont opicon-help-doc register go-helper"
                    target="_blank"
                    href="/document/helper.html"
                  >帮助手册</a>
                </span>
                <span @click="showQrcode">
                  <img src="../../assets/images/ddLogo.png" />
                  <a class="register go-helper">钉钉登录</a>
                </span>
              </div>
            </el-form-item>
          </el-form>
...
import { setToken, setStorage, messageAlert } from "@/shared/utils/utils";
import QrcodeVue from "qrcode.vue";
import useCore from "@/hooks/use-core";
import { userLogin, getVerifyCode, verifyInfo, setNewPass } from "@/api/userApi/index";

const { clearSystemCache } = useCore()
...
/**密码框失去焦点*/
function blurPassword(rule, value, callback) {
  if (
    value !== "" &&
...
/**确认密码失去焦点*/
function blurRePassword(rule, value, callback) {
