        ...
        <div class="login-item">
          ...
          >
            ...
            <div class="msgcode">
              ...
              <div class="msg-right">
                <el-button class="secondMsgBtn" v-if="second == 0" @click="getMsg">{{ secondMsg }}</el-button>
...
import { messageAlert, setToken } from "@/shared/utils/utils";
